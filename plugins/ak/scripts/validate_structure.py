...
REQUIRED_FILES = (
    ...
    "schemas/handoff.schema.json", "schemas/conflict.schema.json", "schemas/run-state.schema.json", "schemas/source-inventory.schema.json", "schemas/work-package.schema.json", "schemas/review-receipt.schema.json",
    ...
    "contracts/bundle.py", "contracts/phase_readiness.py", "contracts/migration.py", "contracts/bundle_assembly.py", "contracts/acquisition_orchestrator.py", "contracts/collaboration.py", "contracts/review.py",
